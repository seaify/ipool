...
(function (root, factory) {
            ...
            if (
              ...
              console.log(this.props);
                ...
                children = children.concat(this.props.columns.map(function(column, i) {
                  ...
                  if(column.label == "checkbox"){
                    //console.log(column);
                    return <Td column={column} key={this.props.key} {...{}}>
                      <Input type='checkbox' ref={index} checked={this.props.checked} label='选中' onChange={this.props.onChange.bind(null, index)}  />
                   </Td>;
                  }
    ...
    var Table = exports.Table = React.createClass({
        ...
        handleRowChange: function(index, e){
          console.log("fuck");
          console.log(index);
          ...
          console.log(_.extend(this.state.rowStates, data));
          this.setState({'rowStates': _.extend(this.state.rowStates, data)});
          //console.log(this.refs.'0'.getDOMNode().checked);
          //console.log(this.refs.'0'.getDOMNode().checked);
          //console.log(this.refs.'1'.getDOMNode().checked);
          /*
        ...
        initialize: function(props) {
            ...
            if('selectedRows' in props){
              var rowStates = {};
              props['selectedRows'].map(function(row) {
                rowStates[row] = true;
              });
              this.setState({'rowStates': rowStates});
            }
        },
          ...
          if(this.props.checkbox == true){
            ...
            if (this.data && typeof this.data.map === 'function') {
                ...
                children = children.concat(this.data.map(function(rawData, i) {
                    ...
                    console.log(i);
                    return (
                        <Tr onChange={this.handleRowChange} checked={rowStates[i]} checkbox={this.props.checkbox} columns={columns} index={i} key={i} data={data} {...props} />
                    );
                }.bind(this)));
            }
